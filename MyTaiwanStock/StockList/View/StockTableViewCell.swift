...
class StockTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        stockName.font = FontManager.shared.customFont(
            name: "PingFangTC-Regular", baseSize: 20, forTextStyle: .title1)
    ...
    @objc func labelTapped() {
        ...
        NotificationCenter.default.post(
            name: NSNotification.Name("labelTapped"), object: nil)
    }
    override func hitTest(_ point: CGPoint, with event: UIEvent?) -> UIView? {
        let labelHitView = stockPriceDiff.hitTest(
            convert(point, to: stockPriceDiff), with: event)
        if labelHitView != nil {
