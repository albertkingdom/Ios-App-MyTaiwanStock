...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func setInitialViewController(in window: UIWindow) {
        ...
        // 主畫面
        let mainVC = container.configureStockListViewController()
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        
        guard let tabBarController = storyboard.instantiateViewController(withIdentifier: "customTabVC") as? CustomTabBarViewController else {
            fatalError("Could not find CustomTabBarViewController in storyboard")
        }
        // Find the NavigationController and inject dependency
